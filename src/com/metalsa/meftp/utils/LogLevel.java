...
public class LogLevel {
	...
	static {
		...
		logger = Logger.getLogger("MeFTPServer");
	    ...
	    private synchronized static void createInstance(Properties properties) throws MeFTPServerException, IOException {
	        if (INSTANCE == null) { 
	    ...
	    public static LogLevel getInstance(Properties properties) throws MeFTPServerException, IOException {
