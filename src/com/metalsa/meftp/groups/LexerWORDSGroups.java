...
public class LexerWORDSGroups{
	/**
	 * 
	 */
	private static final long serialVersionUID = -423678976290101237L;
	
	private static LexerWORDSGroups INSTANCE = null;
	
	private String newResultQuery;
	
	private LexerWORDSGroups(){	
	}
	
	private synchronized static void createInstance(){
		if(INSTANCE == null){
			INSTANCE = new LexerWORDSGroups();
			System.out.println("Obteniendo instancia");
		}
	}

	public static LexerWORDSGroups getInstance(){
		try{
			if(INSTANCE == null)
				createInstance();
