...
public class LexerWORDSFiles{
	/**
	 * 
	 */
	private static final long serialVersionUID = -423678976290101237L;
	
	private static LexerWORDSFiles INSTANCE = null;
	
	private String newResultQuery;
	
	private LexerWORDSFiles(){	
	}
	
	private synchronized static void createInstance(){
		if(INSTANCE == null){
			INSTANCE = new LexerWORDSFiles();
			System.out.println("Obteniendo instancia");
		}
	}

	public static LexerWORDSFiles getInstance(){
		try{
			if(INSTANCE == null)
				createInstance();
