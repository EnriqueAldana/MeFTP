...
var labelComboRecipients = new Ext.form.Label({
	id:'label_dateTo_id',
	text:'Recipients:',
	y:5,
	x:20
...
var comboRecipients = new Ext.form.ComboBox({
	 	 width		:	200,
...
var recipientButton = new Ext.Button({
	     x:330,
	     text:'Remove Recipients',
	     id:'button_remove_id'
});

var addRecipients = new Ext.form.FieldSet({
	width		:	470,
	height		:	240,
	layout		:	'absolute',
